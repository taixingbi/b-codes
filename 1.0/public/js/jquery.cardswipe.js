...
(function (factory) {
	...
	var listener = function (e) {
		...
		switch (state()) {
			...
			case states.IDLE:
                // console.log('rawData: 0'+e.which);

                if (e.which == 37) {
                    // console.log('rawData: 37');
