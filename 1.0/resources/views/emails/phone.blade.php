                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle" class="brdBottomPadd">
                            <tr>
                                <td valign="top" style="text-align: center" class="bodyContent" mc:edit="body_content">
                                    <h3><p class="final"><strong>THANK YOU FOR CHOOSING OUR COMPANY</strong></h3>
                                    Served by: {{ $agent_rents_order['served_by'] }}<br><br>                                    Created at: {{ $agent_rents_order['completed_at'] }}<br>
                                    ...
                                    <br>Total after Tax:<strong> ${{ number_format(floatval($agent_rents_order['price']),2) }}</strong></p><br>
