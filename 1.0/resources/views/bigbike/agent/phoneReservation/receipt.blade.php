    ...
    @if(Session::has('rent_success'))
        ...
        <div class="text-center col-md-12" >
            ...
            <button class="btn btn-success"  onclick="window.print() ">Print Receipt</button>
                    <button style="margin-left: 100px;" class="btn btn-success shak"  onclick="window.location.href='/bigbike/agent/phoneReservation/main'">Go to main page</button>
                ...
                <tr>
                    <td align="center" valign="top">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
                                            ...
                                            <tr>
                                            <tr>
                                                <td><p style="text-align: center"><strong><br><br>Central Park Bike Tours<br> address: {{ $location->title }},<br> New York, NY {{ $location->zipcode }} <br>phone: {{ $location->phone }}<br>email: reservations@bikerent.nyc
                                            <br><br>
                                    </p></td></tr>
                            <td align="center" valign="top">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle" class="brdBottomPadd">
                            <tr>
                                <td valign="top" style="text-align: center" class="bodyContent" mc:edit="body_content">
                                    ...
                                    <p class="final">
                                    Served by: {{ $agent_rents_order['served_by'] }}<br><br>
