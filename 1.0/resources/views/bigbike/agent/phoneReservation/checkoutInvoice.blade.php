...
@section('content')
    ...
    @endif
    @if (Session::has('invoice_conf'))
        @foreach(Session::get('invoice_conf') as $us_con)
    ...
    <div class="wrap">
        ...
        {{--YOUR NUMBER :  "{{(Session::get('invoice_conf'))}} " </div>--}}

        <h2 style="color:white"> Organize:{{$us_con->customer_name}}</h2>
        <form action="https://eastriverparkbikerental.com/invoice/checkout"
              id="payment-form" class="cc_form" method="post">
            <div class="input-wrap group">
                <label for="cc_number"><i class="fa fa-credit-card"></i></label>
                <input type="text" maxlength = "16"
                       name="cc_number" id="cc_number" placeholder="Card Number.." required>
            </div>
            <div class="input-wrap group expiration-wrap" style="width: 50%;">
                <label for="cc_firstname"><i class="fa fa-user"></i></label>
                <input type="text" name="cc_firstname" id="cc_firstname" placeholder="First Name.." value="" required>
            </div>
            <div class="input-wrap group cvc-wrap" style="width: 48%;">
                <label for="cc_lastname"><i class="fa fa-user"></i></label>
                <input type="text" name="cc_lastname" id="cc_lastname" placeholder="Last Name.." value="" required>
            </div>
            <div class="input-wrap group expiration-wrap" style="width: 50%;">
            ...
            <div class="input-wrap group cvc-wrap" style="width: 48%;">
                ...
                <input type="text" name="cc_email" id="cc_email" placeholder="Email.." value="{{$us_con->email}}">
            </div>
            ...
            <div class="group exp-cvc" style="margin-top: 10px;">
                <div class="input-wrap group ">
                    {{--<label for="cc_expiration"><i class="fa fa-calendar"></i></label>--}}
                    <input type="text" style="text-align: center;font-weight: bold" readonly name="price" id="price" pattern="[0-9.]+" value="{{$us_con->price}}">
                </div>
            </div>

            <br>
            <div style="width: 100%;">
                <textarea rows="2" cols="45" form="payment-form" readonly name="description" id="description" class="field is-empty" style="opacity: 1;background-color: white;">{{$us_con->description}}</textarea>
            </div><br>
            {{ csrf_field() }}
